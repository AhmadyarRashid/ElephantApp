...
import { getItemBOM, getNonSpecificBOM, getBOMLineById, deleteBOMLine } from "../../store/actions/bomAction";
import './style.css'
...
class ViewBOM extends React.Component {
    ...
    render() {
        ...
        var buttonText = this.props.bom.bomLine.length > 0 ? "Update BOM" : "Create BOM";
        ...
        return (
            <DefaultLayout title="View Bill of Material">
                ...
                <div className="search-result-list">
                    <Button key="" htmlType="button" type="primary" onClick={this.openCreateForm} disabled={!this.state.can_update_bom}>{buttonText}</Button>
                ...
                >
                    <CreateUpdate
                        ...
                        onCancel={this.handleCancel}
                        handleDelete={this.deleteBOMLine}
                    ></CreateUpdate>
                </Modal>
            </DefaultLayout>
        );
...
export default connect(mapStateToProps,
    {
        ...
        getNonSpecificBOM, getAllCategories, deleteBOMLine
